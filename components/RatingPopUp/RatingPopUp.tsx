...
export default function RatingPopUp({ basePoints }: Props) {
  return (
    <div className='relative flex h-5/6 max-h-[1020px] w-[95%] items-center justify-center bg-main-opposed-500 font-sans lg:aspect-square lg:w-auto'>
      ...
      <div className='absolute right-0 left-0 bottom-0 z-10 h-[40%] w-full overflow-hidden sm:h-[50%] md:h-[55%]'>
        ...
        <div className='absolute bottom-0 flex h-1/3 w-full items-start justify-center bg-second-500'>
          ...
          <div className='absolute -top-[170%] my-auto flex h-7 w-2/3 items-center md:-top-[130%] md:w-5/12'>
            ...
            <LevelIndicator position='left'>34</LevelIndicator>
            <LevelIndicator position='right'>35</LevelIndicator>
          </div>
        </div>
      </div>
      <ul className='relative -mt-[10%] md:-ml-[20%]'>
        <BonusPointsItem multiplier={5}></BonusPointsItem>
        <BonusPointsItem additionalPoints={10}></BonusPointsItem>
        <BonusPointsItem multiplier={3}></BonusPointsItem>
      </ul>
