  ...
  return (
    { profilePath } && (
      <button
        ...
        className='flex flex-row items-center gap-2 border-2 border-second-400/60 bg-second-600 p-2 font-openSans text-xs text-mainText click-behavior radius-default active:scale-90'>
