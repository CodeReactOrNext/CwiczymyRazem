  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // writeup for the contrast table.
        ivory: {
          DEFAULT: "#FAF9F5", // bg-ivory — section background
          surface: "#F0EEE6", // bg-ivory-surface — card level within the ivory section
          fg: "#1C1917", // text-ivory-fg — primary text (16.6:1 on ivory)
          muted: "#57534E", // text-ivory-muted — secondary text (7.2:1 on ivory)
          accent: "#0E7490", // text-ivory-accent — cyan-700, the only accent shade that keeps AA (5.1:1) on a light background
        },
      },
      fontFamily: {
        sans: [
        ...
        // Landing-only display face (see feature/landing/lib/fonts.ts). Scoped
      ...
      keyframes: {
        ...
        "timer-particle": {
          ...
          "50%": {
            transform:
              "translate(var(--particle-x), var(--particle-y)) scale(1)",
            opacity: "0.8",
          },
          "100%": {
            transform:
