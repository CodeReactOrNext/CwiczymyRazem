...
const StatsField = ({ Icon, description, value }: StatsFieldProps) => {
  return (
    <div className='relative right-2 m-2 flex w-32 flex-col border-2  border-second-400 bg-second-600 p-1 font-openSans text-xs shadow-inset-cool shadow-second-700 radius-default sm:w-48 sm:text-sm'>
