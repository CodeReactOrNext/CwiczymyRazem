      ...
      <div className='relative flex h-full flex-col justify-between overflow-hidden rounded-lg p-6 transition-background glass-card hover:glass-card-hover'>
        ...
        <div className='relative'>
          <div className='mb-5 flex items-center justify-between'>
            <div className='flex h-10 w-10 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 transition-colors duration-300 group-hover:bg-cyan-500/15'>
