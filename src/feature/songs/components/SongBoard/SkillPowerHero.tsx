  ...
  return (
    <div className='flex items-center gap-1.5 rounded bg-white/5 px-2 py-1'>
      <span className='text-[10px] font-bold text-zinc-500'>
        {nextTierProgress.songsNeeded} song
        {nextTierProgress.songsNeeded > 1 ? "s" : ""} to
      </span>
      <span
...
export const SkillPowerHero = ({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-lg bg-zinc-900/40 p-8 backdrop-blur-xl",
        className,
      )}>
      ...
      <div className='relative z-10 flex flex-col justify-between gap-8 md:flex-row md:items-center'>
        <div className='space-y-6'>
          <div className='flex items-center gap-3'>
            <div className='flex h-10 w-10 items-center justify-center rounded-[4px] bg-white/5 text-zinc-300 shadow-lg'>
              <TrendingUp size={20} />
            </div>
            <div>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='flex flex-col items-center'>
            <div
              className='mb-3 flex h-24 w-24 items-center justify-center rounded-lg text-4xl font-black shadow-2xl'
              style={{
