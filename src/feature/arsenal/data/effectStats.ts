...
export const EFFECT_FEATURES: EffectFeatureDef[] = [
  ...
  { id: "midi", label: "MIDI control", category: "versatility", min: 2, max: 5, appliesTo: ["Delay", "Reverb", "Chorus", "Phaser", "Flanger"] },
  { id: "tap-tempo", label: "Tap tempo", category: "versatility", min: 2, max: 4, appliesTo: ["Delay", "Chorus", "Phaser", "Flanger"] },
  { id: "stereo-io", label: "Stereo I/O", category: "versatility", min: 2, max: 4, appliesTo: ["Delay", "Reverb", "Chorus", "Phaser", "Flanger"] },
  { id: "presets", label: "Presets", category: "versatility", min: 2, max: 4, appliesTo: ["Delay", "Reverb", "Chorus", "Phaser", "Flanger", "EQ"] },
  { id: "expression-in", label: "Expression input", category: "versatility", min: 1, max: 3, appliesTo: ["Delay", "Reverb", "Wah", "Phaser", "Flanger", "Chorus"] },
