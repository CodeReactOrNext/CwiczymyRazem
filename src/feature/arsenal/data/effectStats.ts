...
export const EFFECT_FEATURES: EffectFeatureDef[] = [
  ...
  {
    id: "nos-opamp",
    label: "NOS op-amp (JRC4558)",
    category: "tone",
    min: 2,
    max: 5,
    appliesTo: ["Overdrive", "Distortion", "Boost", "Compressor"],
  },
  {
    id: "germanium-diodes",
    label: "Germanium diodes",
    category: "tone",
    min: 2,
    max: 4,
    appliesTo: ["Overdrive", "Distortion", "Fuzz", "Boost"],
  },
  {
    id: "matched-transistors",
    label: "Matched transistors",
    category: "tone",
    min: 2,
    max: 4,
    appliesTo: ["Fuzz", "Overdrive", "Distortion"],
  },
  {
    id: "asym-clipping",
    label: "Asymmetric clipping",
    category: "tone",
    min: 1,
    max: 3,
    appliesTo: ["Overdrive", "Distortion", "Fuzz"],
  },
  {
    id: "led-clipping",
    label: "LED clipping",
    ...
    min: 1,
    max: 2,
    appliesTo: ["Overdrive", "Distortion"],
  },
  {
    id: "mosfet-clipping",
    label: "MOSFET clipping",
    category: "tone",
    min: 1,
    max: 2,
    appliesTo: ["Overdrive", "Distortion", "Boost"],
  },
  {
    id: "carbon-comp",
    label: "Carbon comp resistors",
    category: "tone",
    min: 1,
    max: 2,
  },
  ...
  // Versatility — controls / routing
  {
    ...
    min: 2,
    max: 5,
    appliesTo: ["Delay", "Reverb", "Chorus", "Phaser", "Flanger", "Vibrato"],
  },
  {
    id: "tap-tempo",
    label: "Tap tempo",
    ...
    min: 2,
    max: 4,
    appliesTo: ["Delay", "Chorus", "Phaser", "Flanger", "Vibrato"],
  },
  {
    id: "stereo-io",
    label: "Stereo I/O",
...
export const getEffectValue = (
  effect: Pick<EffectDefinition, "rarity">,
): number => RARITY_EFFECT_VALUE[effect.rarity] ?? 0;
...
export const sumEffectStats = (features: ItemFeature[]): EffectStats => {
...
export const getEffectFeatures = (
  item: Pick<EffectInventoryItem, "features">,
): ResolvedEffectFeature[] =>
  (item.features ?? [])
    .map((f) => {
      const def = EFFECT_FEATURES_BY_ID.get(f.id);
...
export const getEffectStats = (
  item: Pick<EffectInventoryItem, "stats">,
