...
export const EquipTargetDialog = ({
  ...
  const options: {
    ...
    {
      target: "profile",
      label: "Profile guitar",
      desc: "Shown on your avatar",
      active: isEquipped,
      taken: false,
    },
    {
      target: 0,
      label: "Rig slot 1",
      desc: "Place in your rig",
      active: rigSlots[0] === itemId,
      taken: !!rigSlots[0] && rigSlots[0] !== itemId,
    },
    {
      target: 1,
      label: "Rig slot 2",
      desc: "Place in your rig",
      active: rigSlots[1] === itemId,
      taken: !!rigSlots[1] && rigSlots[1] !== itemId,
    },
    {
      target: 2,
      label: "Rig slot 3",
      desc: "Place in your rig",
      active: rigSlots[2] === itemId,
      taken: !!rigSlots[2] && rigSlots[2] !== itemId,
    },
  ];
    ...
    <div
      ...
      <div
        ...
        <div className='flex flex-col gap-2'>
          {options.map((o) => (
            <div key={String(o.target)} className='flex items-stretch gap-2'>
              <button
                ...
                <span className='flex items-center gap-3'>
                  ...
                  <span className='flex flex-col'>
                    ...
                    <span className='text-[11px] text-zinc-500'>
                      {o.taken ? "Occupied — will replace" : o.desc}
                    </span>
                  </span>
                </span>
                {o.active && (
                  <Check size={16} strokeWidth={3} className='text-amber-400' />
                )}
              </button>
              {o.active && (
                <button
