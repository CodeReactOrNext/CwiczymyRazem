...
export const ROADMAP_TIERS: RoadmapTier[] = [
  ...
  { id: "t237", goal: 237, icon: Target, label: "+4 New Exercises", kind: "content" },
  {
    id: "t247",
    goal: 247,
    icon: Wand2,
  ...
  { id: "t265", goal: 265, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  { id: "t275", goal: 275, icon: Target, label: "+1 New Exercise", kind: "content" },
  { id: "t293", goal: 293, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  { id: "t303", goal: 303, icon: Target, label: "+1 New Exercise", kind: "content" },
  { id: "t321", goal: 321, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  {
    id: "t331",
    goal: 331,
    icon: Swords,
  ...
  { id: "t349", goal: 349, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  { id: "t359", goal: 359, icon: Target, label: "+1 New Exercise", kind: "content" },
  { id: "t377", goal: 377, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  { id: "t385", goal: 385, icon: Guitar, label: "+5 New Guitars & Pedals", kind: "content" },
  {
    id: "t400",
    goal: 400,
    icon: Gamepad2,
