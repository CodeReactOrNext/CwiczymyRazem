      ...
      <section className='rounded-lg bg-zinc-900/40 p-5 sm:p-6'>
        ...
        <div className='relative -mx-5 mt-4 sm:-mx-6'>
          ...
          <div
            ...
            className='overflow-x-auto px-5 pb-4 sm:px-6 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-zinc-600 [&::-webkit-scrollbar-thumb]:hover:bg-zinc-500 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-zinc-800/50 [&::-webkit-scrollbar]:h-3'>
            <div
              className='relative'
