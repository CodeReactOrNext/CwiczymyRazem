...
export const specialAchievements = [
  ...
  achivFactor("doctor" as AchievementList, FaUserMd, "rare", AchievementRequirement.statThreshold("habitsCount", 100)),
  ...
  achivFactor("medal" as AchievementList, FaMedal, "veryRare", (ctx) => ctx.statistics.maxPoints >= 200),
  ...
  achivFactor("batteryHearth" as AchievementList, GiHeartBattery, "epic", AchievementRequirement.statThreshold("habitsCount", 2000)),
