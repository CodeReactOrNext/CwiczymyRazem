...
import spiderPermutation2431Image from "public/images/exercises/spiderPermutation2431.png";

export const spiderPermutation2431Exercise: Exercise = {
  id: "spider_permutation_2431",
  title: {
    pl: "Pajączek - permutacja 2-4-3-1",
    en: "Spider Exercise - 2-4-3-1 Permutation",
  },
  description: {
    pl: "Chromatyczne ćwiczenie z wykorzystaniem permutacji palców 2-4-3-1, rozwijające niezależność palców i koordynację.",
    en: "Chromatic exercise using finger permutation 2-4-3-1, developing finger independence and coordination.",
  },
  difficulty: "medium",
  category: "technique",
  timeInMinutes: 5,
  instructions: [
    ...
    {
      pl: "Zacznij grać według permutacji 2-4-3-1, czyli: palec 2, palec 4, palec 3, palec 1.",
      en: "Start playing according to the permutation 2-4-3-1, which means: finger 2, finger 4, finger 3, finger 1.",
    },
    {
