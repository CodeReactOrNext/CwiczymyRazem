...
export const stringSweepGExercise: Exercise = {
  id: "string_sweep_g",
  addedAt: "2026-08-03",
  isHiddenFromLanding: true,
  title: "String Sweep — G",
  ...
  tips: [
    "Pitch detection hears the note, not the string — it can't literally verify you played it on the G string specifically. Use this exercise honestly, the same way you would with a teacher watching.",
