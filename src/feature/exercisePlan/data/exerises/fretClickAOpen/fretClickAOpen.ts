...
export const fretClickAOpenExercise: Exercise = {
  id: "fret_click_a_open",
  addedAt: "2026-08-03",
  isHiddenFromLanding: true,
  title: "Click Hunt — A String, Frets 0–6",
  ...
  instructions: [
    ...
    "Click the cell on the A (5th) string, between frets 0 and 6, where that note lives.",
    "Once found, a new note rolls in — no mic needed, just click.",
  ],
  tips: [
    "Count up in half-steps from the open string: A, A#, B, C, C#, D, D#.",
    "Fret 5 on the A string is D — the same pitch as the open D string, a handy checkpoint.",
  ],
  whyItMatters: "The A string is the second most-used root reference after low E — most open chords and A-shape barre chords key off it. Locking in the first 6 frets by sight builds the second pillar of full-neck fretboard knowledge.",
  metronomeSpeed: null,
  relatedSkills: ["music_theory"],
  disableBackingTrack: true,
  disableMic: true,
  customGoal: currentTarget,
  customGoalDescription: "Click this note on the A string (frets 0-6)",
