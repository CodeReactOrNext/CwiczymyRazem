...
import spiderPermutation1432Image from "public/images/exercises/spiderPermutation1432.png";

export const spiderPermutation1432Exercise: Exercise = {
  id: "spider_permutation_1432",
  title: {
    pl: "Pajączek - permutacja 1-4-3-2",
    en: "Spider Exercise - 1-4-3-2 Permutation",
  },
  description: {
    pl: "Chromatyczne ćwiczenie z wykorzystaniem permutacji palców 1-4-3-2, rozwijające niezależność palców i koordynację.",
    en: "Chromatic exercise using finger permutation 1-4-3-2, developing finger independence and coordination.",
  },
  difficulty: "medium",
  category: "technique",
  timeInMinutes: 5,
  instructions: [
    ...
    {
      pl: "Zacznij grać według permutacji 1-4-3-2, czyli: palec 1, palec 4, palec 3, palec 2.",
      en: "Start playing according to the permutation 1-4-3-2, which means: finger 1, finger 4, finger 3, finger 2.",
    },
    {
