...
export const stringHuntBExercise: Exercise = {
  ...
  tips: [
    "Pitch detection can't tell which string you plucked, but it does hear the octave — and inside frets 0–11 the B string holds each note in exactly one octave. Grab the same note on another string and it lands in the wrong octave, so it won't count.",
