  ...
  tablature: [
    // M1: Half-step bends on string 2 — target fret 8, bend from 7
    {
      ...
      beats: [
        ...
        { duration: 0.5, notes: [{ string: 2, fret: 7, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 8 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 7, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 8 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 8 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7, isBend: true, bendSemitones: 1 }] },
      ],
    },
    // M2: Half-step bends at 5th position
    {
      timeSignature: [4, 4],
      beats: [
        { duration: 0.5, notes: [{ string: 2, fret: 6 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 5, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 6 }] },
    ...
    // M4: Whole-step bends at 5th position
    {
      timeSignature: [4, 4],
      beats: [
        { duration: 0.5, notes: [{ string: 2, fret: 7 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 5, isBend: true, bendSemitones: 2 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 5, isBend: true, bendSemitones: 2 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 7 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 5, isBend: true, bendSemitones: 2 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 5, isBend: true, bendSemitones: 2 }] },
    ...
    // M5: Alternating half/whole bends with release — string 2
    {
      ...
      beats: [
        { duration: 0.5, notes: [{ string: 2, fret: 7, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 7, isRelease: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 7, isBend: true, bendSemitones: 2 }] },
        { duration: 0.5, notes: [{ string: 2, fret: 7, isRelease: true, bendSemitones: 2 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7, isBend: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7, isRelease: true, bendSemitones: 1 }] },
        { duration: 0.5, notes: [{ string: 3, fret: 7, isBend: true, bendSemitones: 2 }] },
