...
export const oneChordImprovExercise: Exercise = {
  ...
  backingTrackSearchQueries: [
    "Single Chord Backing Track",
    "One Chord Jam Track Guitar",
    "Chord Vamp Backing Track",
    "One Chord Groove Backing Track",
    "Static Chord Drone Backing Track Guitar",
  ],
  difficulty: "medium",
  category: "creativity",
  timeInMinutes: 5,
