...
import spiderPermutation2413Image from "public/images/exercises/spiderPermutation2413.png";


export const spiderPermutation2413Exercise: Exercise = {
  id: "spider_permutation_2413",
  title: {
    pl: "Pajączek - permutacja 2-4-1-3",
    en: "Spider Exercise - 2-4-1-3 Permutation",
  },
  description: {
    pl: "Chromatyczne ćwiczenie z wykorzystaniem permutacji palców 2-4-1-3, rozwijające niezależność palców i koordynację.",
    en: "Chromatic exercise using finger permutation 2-4-1-3, developing finger independence and coordination.",
  },
  difficulty: "medium",
  category: "technique",
  timeInMinutes: 5,
  instructions: [
    ...
    {
      pl: "Zacznij grać według permutacji 2-4-1-3, czyli: palec 2, palec 4, palec 1, palec 3.",
      en: "Start playing according to the permutation 2-4-1-3, which means: finger 2, finger 4, finger 1, finger 3.",
    },
    {
  ...
  tips: [
    {
      pl: "Przejście 4-1 jest szczególnie trudne - wymaga dużego przeskoku palca 1 pod palcem 4.",
      en: "The 4-1 transition is particularly challenging - requiring a large jump of finger 1 under finger 4.",
    },
    {
