...
export const PROGRESSIONS: Progression[] = [
  // ── Three chords ───────────────────────────────────────────────────────────
  {
    id: "I-IV-V",
    degrees: ["I", "IV", "V"],
    heardIn: "Twist and Shout · La Bamba",
  },
  { id: "I-V-IV", degrees: ["I", "V", "IV"], heardIn: "Sweet Home Alabama" },
  {
    id: "I-vi-IV",
    degrees: ["I", "vi", "IV"],
    heardIn: "Every Breath You Take",
  },
  {
    id: "vi-IV-I",
    degrees: ["vi", "IV", "I"],
    heardIn: "Zombie · Save Tonight",
  },
  ...
  // ── Four chords ────────────────────────────────────────────────────────────
  {
    id: "I-V-vi-IV",
    degrees: ["I", "V", "vi", "IV"],
    heardIn: "Let It Be · With or Without You",
  },
  {
    id: "I-vi-IV-V",
    degrees: ["I", "vi", "IV", "V"],
    heardIn: "Stand By Me · doo-wop",
  },
  {
    id: "vi-IV-I-V",
    degrees: ["vi", "IV", "I", "V"],
    heardIn: "Grenade · Africa",
  },
  {
    id: "I-IV-vi-V",
    degrees: ["I", "IV", "vi", "V"],
    heardIn: "She Will Be Loved",
  },
  {
    id: "I-vi-ii-V",
    degrees: ["I", "vi", "ii", "V"],
    heardIn: "Blue Moon · Heart and Soul",
  },
  ...
  // ── Four chords, with the mediant in play ──────────────────────────────────
  {
    id: "I-iii-IV-V",
    degrees: ["I", "iii", "IV", "V"],
    heardIn: "Crocodile Rock",
  },
  {
    id: "iii-vi-ii-V",
    degrees: ["iii", "vi", "ii", "V"],
    heardIn: "The long jazz turnaround",
  },
  { id: "I-V-vi-iii", degrees: ["I", "V", "vi", "iii"], heardIn: "Canon in D" },
  {
    id: "vi-V-IV-iii",
    degrees: ["vi", "V", "IV", "iii"],
    heardIn: "The Andalusian descent",
  },
];
...
export const formatDegrees = (degrees: DegreeId[]): string =>
  degrees.join(" – ");
...
const SUFFIX: Record<DegreeSpec["quality"], string> = {
  major: "",
  minor: "m",
  dim: "dim",
};
 ...
 */
export const buildProgressionChords = (
  keyRootMidi: number,
  degrees: DegreeId[],
): ProgressionChord[] =>
  degrees.map((degree) => {
    ...
    return {
      ...
      midis: [
        root - 12,
        ...TRIADS[quality].map((semitones) => root + semitones),
      ],
    };
  });
