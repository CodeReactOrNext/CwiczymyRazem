    ...
    <div className='flex flex-col gap-6 relative'>
      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-1.5 text-[10px] font-bold tracking-wider text-zinc-500 mb-0.5">
            ...
            <div className="flex flex-wrap gap-2">
                ...
                {Object.keys(groupedExercises).map((category) => (
                    ...
                    >
                        ...
                        <span className={cn(
                            "ml-1.5 px-1.5 py-0.5 rounded text-[9px] font-bold transition-colors duration-300",
