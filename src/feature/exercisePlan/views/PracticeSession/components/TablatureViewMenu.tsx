...
interface TablatureViewMenuProps {
  ...
  /** Flat tablature needs rendered measures. */
...
/**
 * Single control that swaps between the tablature views (flat tab / notation)
 * via a dropdown. The two views are mutually exclusive, so selecting one just
 * toggles the notation flag.
 */
export const TablatureViewMenu = memo(function TablatureViewMenu({
  ...
  if (hasTablature) options.push("tab");
