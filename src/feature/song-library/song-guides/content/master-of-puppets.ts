...
export const masterOfPuppets: SongGuide = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "master of puppets downpicking",
      "master of puppets bpm guitar",
  ...
  techniques: {
    ...
    intro:
      "Every technique here is standard metal vocabulary. What Master of Puppets changes is the intensity dial.",
    items: [
      {
        name: "Downpicking stamina",
        difficulty: 5,
        role: "core",
        description:
      ...
      },
      {
        ...
        role: "core",
        description:
          "The riffs alternate muted chugs and open accents inside single bars. The contrast is the groove; smear it and the riff dies.",
      },
      {
        name: "Fast chord shifts (E5 shapes & chromatics)",
        difficulty: 4,
        role: "core",
        description:
      ...
      },
      {
        ...
        role: "core",
        description:
          "The mid-song breather is its own piece: clean-tone arpeggios under a melodic harmonized solo. Exposed playing with no distortion to hide behind.",
      },
      {
        name: "Wah solo (Hammett)",
        difficulty: 5,
        role: "bonus",
        description:
  ...
  songMap: {
    ...
    sections: [
      ...
      },
      {
        ...
        isHardest: true,
        description:
          "The E5-and-chromatics engine of the song. All downstrokes, palm-muted, at ≈212 BPM, repeated for minutes. This riff IS the difficulty rating.",
      },
      {
        name: "Verse & pre-chorus",
        difficulty: 7.5,
        description:
          "Variations on the engine with accent shifts and quick chord stabs. Slightly kinder than the main riff, but there's no coasting.",
      },
      {
  ...
  riffPreview: {
    ...
    intro: "A short tab from the song's iconic opening riff.",
    measures: masterOfPuppetsRiffPreviewExercise.tablature!,
    bpm: masterOfPuppetsRiffPreviewExercise.metronomeSpeed!.recommended,
    bpmMin: masterOfPuppetsRiffPreviewExercise.metronomeSpeed!.min,
    bpmMax: masterOfPuppetsRiffPreviewExercise.metronomeSpeed!.max,
    practiceExerciseId: masterOfPuppetsRiffPreviewExercise.id,
  },
  timeline: {
    heading: "Realistic timelines (yes, months)",
    intro:
      "Data point worth internalizing: almost nobody 'learns' Master of Puppets in one push. Players who make it treat tempo as a training metric.",
    entries: [
      {
        level: "Intermediate (2–4 years, some metal)",
        time: "3–6 months",
        note: "All riffs at 70% within weeks; the long climb to 212 BPM with clean muting is where the months go.",
      },
      {
        level: "Advanced rhythm player",
        time: "4–8 weeks",
        note: "Notes in days. The work is stamina at tempo and making the interlude actually musical.",
      },
      {
    ...
    easier: [
      {
        ...
        artist: "Metallica",
        difficulty: 5,
        why: "The perfect downpicking primer: same attack, same muting, half the speed pressure.",
        songId: "Llqs4ctn2vjTugrVHxnq",
      },
      {
        title: "Enter Sandman",
        artist: "Metallica",
  ...
  progression: {
    ...
    description:
      "One of the toughest rungs on the ladder: the classic 'proof of rhythm hand' song. Own it at tempo and there's little left to prove but speed.",
  },
