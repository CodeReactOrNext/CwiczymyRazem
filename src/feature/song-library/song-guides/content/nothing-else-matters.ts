...
export const nothingElseMatters: SongGuide = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "how hard is nothing else matters on guitar",
      "nothing else matters fingerpicking",
      "nothing else matters for beginners",
      "learn nothing else matters guitar",
  ...
  facts: [
    { label: "Artist", value: "Metallica (The Black Album, 1991)" },
    ...
    items: [
      {
        ...
        role: "core",
        description:
          "The heart of the song. Thumb covers the low E, index and middle roll through the open B and high E strings. The pattern repeats so often it becomes automatic within days.",
      },
      {
        name: "Chord arpeggios up the neck",
        difficulty: 3,
        role: "core",
        description:
          "The interlude fingerpicks fretted shapes around the 7th–9th frets. Same right hand, but now the left hand has to hold clean shapes while strings ring together.",
      },
      {
        name: "Dynamics & right-hand control",
        difficulty: 3,
        role: "core",
        description:
          "The song lives and dies on the difference between the whispered verses and the big choruses. Learning to control volume with your fingers is the real skill being trained.",
      },
      {
        name: "Strummed power-chord chorus",
        difficulty: 2,
        role: "core",
        description:
          "The chorus shifts to picked/strummed chords. The switch from fingers to a heavier attack (or hybrid picking) mid-song is a small skill of its own.",
      },
      {
        name: "Expressive bends & vibrato (solo)",
        difficulty: 4,
        role: "bonus",
        description:
  ...
  songMap: {
    ...
    sections: [
      ...
      },
      {
        ...
        difficulty: 3,
        description:
          "The intro pattern continues under vocal phrases with small chord movements (Em, D, C, G). The challenge is keeping the pattern even while shapes change.",
      },
      {
        name: "Chorus",
        difficulty: 3.5,
      ...
      },
      {
        ...
        difficulty: 5,
        description:
          "Fretted arpeggio shapes higher up the neck with position shifts. The left hand finally has to work. Most players plateau here for a week or two.",
      },
      {
        name: "Solo",
        difficulty: 6.5,
    ...
    hardestSummary:
      "The hardest 20 seconds of the song is the fast descending run at the end of the solo. It's the only moment that demands speed. Everything else that's 'hard' in Nothing Else Matters is hard in the exposed-and-slow way: there's nowhere to hide a buzzing note when the whole band drops to a whisper.",
  },
  timeline: {
    ...
    entries: [
      {
        ...
        time: "2–4 weeks",
        note: "Intro, verse, and chorus sounding clean. The interlude will be rough; park the solo for now.",
      },
      {
        level: "Intermediate (1–3 years)",
        time: "about a week",
        note: "Full song including interlude. The solo's bends and final run take a second week of focused work.",
      },
      {
        level: "Advanced",
        time: "2–3 days",
  ...
  practicePlan: {
    ...
    intro:
      "The song layers naturally. Learn it in this order and you'll always have something playable while the next layer cooks.",
    steps: [
  ...
  finalCta: {
    ...
    headingAccent: "by layer.",
    text: "Add Nothing Else Matters to your Want to Learn list, log your practice, and let the community's difficulty data pick your next song at exactly the right level.",
  },
  faq: [
    {
  ...
  customBlocks: [
    {
      ...
      id: "picking-roadmap",
      heading: "The fingerpicking pattern, decoded",
      intro:
        "One pattern powers most of the song. Break it into these four moves and the intro assembles itself.",
      steps: [
        {
        ...
        },
        {
          ...
          description:
            "The magic is sympathetic ringing: no finger should touch a string that's still sounding. If the texture sounds dry, something is muting.",
        },
        {
