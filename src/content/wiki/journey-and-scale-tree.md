...
<StepList steps="The first step is always open::No prerequisites, on either module|Steps unlock in order::The next step opens once you've marked the one before it complete|Modules aren't locked::Both live modules are open from day one — only the steps inside them unlock in sequence" />
