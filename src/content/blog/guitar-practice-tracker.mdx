...
description: "A guitar practice tracker that works: the 5 metrics that actually predict progress, plus a simple habit template to log them in under a minute."
date: "2026-01-13"
