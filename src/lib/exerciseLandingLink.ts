...
const EMBEDDED_EXERCISE_PAGE: Record<string, SeoLandingPageKey> = {
  ...
  strumming_funk: "intermediate",
  muting_discipline_drill: "intermediate",
  smooth_chord_transitions: "intermediate",
  minimal_motion_voice_leading: "intermediate",
  fretboard_mastery: "intermediate",
  sing_what_you_play: "intermediate",
