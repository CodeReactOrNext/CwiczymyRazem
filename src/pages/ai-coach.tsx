  ...
  if (!isMaster && userInfo !== null) {
    return (
      <PremiumFeaturePreview
        eyebrow="Generate your roadmap"
        title="Mastery Roadmaps"
        description="Get a personalized mastery roadmap generated by AI. Define your goals and receive a step-by-step practice plan designed specifically for your skill level and musical aspirations."
        features={[
          {
            icon: <Map className="h-5 w-5" />,
            label: "Personalized Roadmap",
            description: "AI-generated mastery roadmaps tailored to your musical goals",
          },
          {
