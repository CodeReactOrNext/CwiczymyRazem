...
import { dailyPracticePlanConfig } from "feature/seoLanding/content";
import { buildSeoLandingProps } from "feature/seoLanding/lib/buildSeoLandingProps";
import type { GetStaticProps } from "next";

const DailyPracticePlanPage = (props: SeoLandingPageProps) => (
  <SeoLandingPage {...props} />
);

export const getStaticProps: GetStaticProps<SeoLandingPageProps> = async () => ({
  props: buildSeoLandingProps(dailyPracticePlanConfig),
});

export default DailyPracticePlanPage;
