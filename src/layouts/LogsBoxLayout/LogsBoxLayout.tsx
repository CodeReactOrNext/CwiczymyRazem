...
const LogsBoxLayout = ({
  ...
  return (
    <div className='relative m-auto mt-5 flex h-[600px] flex-col border-4 border-second-400/60 bg-second-500/80 p-1 font-openSans text-xs leading-5 radius-default xs:p-5 xs:pb-0 md:mt-0 lg:text-sm xl:w-[100%]'>
