...
const LandingNav = ({
  ...
  return (
    <div className='relative flex w-full bg-white py-2 text-base uppercase text-main-opposed-text sm:text-2xl md:justify-around md:gap-x-[150px] xl:gap-x-[250px]'>
