...
const Stopwatch = ({
  ...
  return (
    <div className='mb-6 grid h-52 w-52 grid-rows-3 items-center rounded-full border border-second-400 bg-second  text-7xl tracking-wider  text-tertiary shadow-inset-cool shadow-second-400 xs:h-64 xs:w-64 sm:text-8xl'>
      ...
      {isSkillChosen && (
        <div className='row-start-3  text-center font-openSans text-sm text-tertiary'>
          {timerEnabled ? (
            <button
      ...
      {!isSkillChosen && (
        <p className='m-auto w-24 text-center font-openSans text-sm text-mainText'>
          {t("choose")}
        </p>
      )}
    </div>
