...
export function ActivityChart({ data }: ActivityChartProps) {
  ...
  return (
    <Card>
      <CardHeader className="flex font-openSans items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
          ...
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillTechnique" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-technique)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-technique)" stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillTheory" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-theory)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-theory)" stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillHearing" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-hearing)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-hearing)" stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillCreativity" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-creativity)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-creativity)" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            ...
            <ChartTooltip
              ...
              content={(props) => {
                ...
                if (active && payload && payload.length) {
                  return (
                    <div className="rounded-lg text-black font-openSans border bg-white p-2 shadow-sm">
